const SuccessStories = () => {
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-4">Erfolgsgeschichten - Invin Society</h1>
      <p className="mb-4">
        Lassen Sie sich von den inspirierenden Erfolgsgeschichten unserer Kunden motivieren. Lesen Sie Testimonials und Bewertungen, um zu sehen, wie wir anderen geholfen haben, ihre finanziellen und persönlichen Ziele zu erreichen.
      </p>
